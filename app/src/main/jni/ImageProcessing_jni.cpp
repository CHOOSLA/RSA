...
JNIEXPORT jboolean JNICALL Java_kr_ac_sch_oopsla_rsa_process_ImageProcess_nativeImageProcessing
  (JNIEnv *env, jclass thiz, jint width, jint height, jbyteArray NV21FrameData, jintArray outPixels)
{
	jbyte * pNV21FrameData = env->GetByteArrayElements(NV21FrameData, 0);
	jint * poutPixels = env->GetIntArrayElements(outPixels, 0);

	process((unsigned char *)pNV21FrameData,(unsigned char *)poutPixels,(int)width, (int)height);
