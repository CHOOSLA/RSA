...
class CamView2 extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    private GraphView_cus mHeartView = null;
    ...
    public CamView2(Context context, Camera camera, GraphView_cus heartView, HeartRate heartRate,
        ...
        startButton.setBackgroundResource(R.drawable.dark_blue_rec_style);
        stopButton.setBackgroundResource(R.drawable.dark_blue_rec_style);
    ...
    public TextFileWrite<Double> getTextObject() {
        return textFile;
    }
    ...
    public void onPreviewFrame(byte[] data, Camera cam) {
        ...
        if(interval_time >= 10000){
            if(isStartClicked){
                ...
                startButton.setBackgroundResource(R.drawable.blue_rec_style);
                stopButton.setBackgroundResource(R.drawable.blue_rec_style);
                isMessageReady = true;
            }
