...
public class ViewIndividualActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String last_day = mArrayList.get(mArrayList.size() - 1).substring(0, 10);
        ...
        btnBack = (Button) findViewById(R.id.button_view_result_back);
        btnBack.setOnClickListener(this);


        btnLeft = (Button) findViewById(R.id.button_view_result_left);
        ...
        tv4 = (TextView) findViewById(R.id.text_view_result_name); // name

        heartGraph = (CustomGraphView2) findViewById(R.id.custom_view_result_graph);
